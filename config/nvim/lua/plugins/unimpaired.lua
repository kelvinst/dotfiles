...
return {
	...
	keys = {
		...
		{ "<leader>ton", "yon", desc = "Toggle [n]umber" },
		{ "<leader>tor", "yor", desc = "Toggle [r]elativenumber" },
		{ "<leader>tos", "yos", desc = "Toggle [s]pell" },
		{ "<leader>tou", "you", desc = "Toggle c[u]rsorcolumn" },
		{ "<leader>tob", "yob", desc = "Toggle [v]irtualedit" },
		{ "<leader>tow", "yow", desc = "Toggle [w]rap" },
		{ "<leader>tox", "yox", desc = "Toggle [x]hairs (cursorline and cursorcolumn)" },
		{ "<leader>tq", toggle_quickfix, desc = "Toggle [q]uickfix", silent = true },
		{
			"<leader>tx",
			function()
